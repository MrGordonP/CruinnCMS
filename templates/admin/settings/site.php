...
<form method="post" action="<?= url('/admin/settings/site') ?>">
    ...
    <div class="form-row">
        <div class="form-group">
            <label for="site_logo">Logo Path</label>
            <input type="text" id="site_logo" name="site_logo" class="form-input"
                   value="<?= e($settings['site.logo'] ?? '') ?>"
                   placeholder="/uploads/logo.png">
            <small class="form-help">Relative path to the site logo image.</small>
        </div>
        <div class="form-group">
            ...
            <small class="form-help">Header banner image path.</small>
        </div>
    </div>

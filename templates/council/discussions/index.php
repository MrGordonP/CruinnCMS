<div class="council-discussions">
    <div class="page-header">
        <h1>Discussions</h1>
        <a href="/council/discussions/new" class="btn btn-primary">New Discussion</a>
    </div>

    <!-- Filters -->
    <form class="filter-bar" method="get" action="/council/discussions">
        ...
        <?php if ($category || $search): ?>
            <a href="/council/discussions" class="btn btn-link">Clear</a>
        <?php endif; ?>
    </form>

    <?php if ($total === 0): ?>
        <p class="empty-state">No discussions found. <a href="/council/discussions/new">Start the first one!</a></p>
    <?php else: ?>

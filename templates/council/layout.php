...
<header class="admin-header council-header">
    <div class="admin-header-inner">
        <a href="<?= url('/council') ?>" class="admin-logo"><?= e(\Cruinn\App::config('site.name', 'Council')) ?></a>
        <nav class="admin-nav">
            <?php if (!empty($role_nav_items)): ?>
                ...
                <?php if (\Cruinn\Auth::hasRole('admin')): ?>
                    <a href="<?= url('/admin') ?>" class="admin-nav-council">Admin</a>
                <?php endif; ?>
                <span class="admin-user"><?= e($current_user['name'] ?? 'Council') ?></span>
                <a href="<?= url('/') ?>" class="admin-view-site" target="_blank">View Site</a>
                <a href="<?= url('/logout') ?>">Logout</a>
            <?php else: ?>
                <a href="<?= url('/council') ?>">Dashboard</a>
                <a href="<?= url('/council/documents') ?>">Documents</a>
                <a href="<?= url('/council/discussions') ?>">Discussions</a>
                <a href="<?= url('/council/inbox') ?>">Inbox</a>
                <div class="admin-nav-sep"></div>
                <?php if (\Cruinn\Auth::hasRole('admin')): ?>
                    <a href="<?= url('/admin') ?>" class="admin-nav-council">Admin</a>
                <?php endif; ?>

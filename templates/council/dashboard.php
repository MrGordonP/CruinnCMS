<div class="council-dashboard">
    <h1>Council Workspace</h1>

    <div class="stats-grid">
        <div class="stat-card">
            <span class="stat-number"><?= (int)($stats['documents'] ?? 0) ?></span>
            <span class="stat-label">Documents</span>
            <a href="/council/documents" class="stat-link">View All</a>
        </div>
        <div class="stat-card stat-card-warning">
            <span class="stat-number"><?= (int)($stats['pending'] ?? 0) ?></span>
            <span class="stat-label">Pending Approval</span>
            <a href="/council/documents?status=submitted" class="stat-link">Review</a>
        </div>
        <div class="stat-card">
            <span class="stat-number"><?= (int)($stats['discussions'] ?? 0) ?></span>
            <span class="stat-label">Discussions</span>
            <a href="/council/discussions" class="stat-link">View All</a>
        </div>
        <div class="stat-card">

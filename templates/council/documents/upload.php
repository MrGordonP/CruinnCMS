<div class="council-document-upload">
    ...
    <form method="post" action="/council/documents" enctype="multipart/form-data" class="council-form">
        <?= csrf_field() ?>
        ...
        <div class="form-actions">
            ...
            <a href="/council/documents" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>

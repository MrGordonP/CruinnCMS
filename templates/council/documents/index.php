<div class="council-documents">
    <div class="page-header">
        <h1>Documents</h1>
        <a href="/council/documents/new" class="btn btn-primary">Upload Document</a>
    </div>

    <!-- Filters -->
    <form class="filter-bar" method="get" action="/council/documents">
        ...
        <?php if ($category || $status || $search): ?>
            <a href="/council/documents" class="btn btn-link">Clear</a>
        <?php endif; ?>
    </form>
    ...
    <?php else: ?>
        ...
        <table class="admin-table">
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <a href="/council/documents/<?= (int)$doc['id'] ?>"><?= e($doc['title']) ?></a>
                    </td>

...
namespace IGA\Module\FileManager\Services;

use IGA\App;
use IGA\Module\FileManager\Services\Adapters\DocxAdapter;
use IGA\Module\FileManager\Services\Adapters\PdfAdapter;
...
class DocumentService
{
    ...
    private function wrapForExport(string $html, string $title): string
    {
        ...
        $siteName = htmlspecialchars(App::config('site.name', 'IGA Portal'), ENT_QUOTES, 'UTF-8');

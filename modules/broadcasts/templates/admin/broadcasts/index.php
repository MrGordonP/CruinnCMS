<div class="admin-page broadcasts-page">
    <div class="admin-page-header">
        ...
        <a href="<?= url('/admin/broadcasts/new') ?>" class="btn btn-primary">+ New Broadcast</a>
    </div>

    <?php if (empty($broadcasts)): ?>
        <p class="text-muted">No broadcasts yet. <a href="<?= url('/admin/broadcasts/new') ?>">Create your first broadcast.</a></p>
    <?php else: ?>
        <table class="admin-table">
            ...
            <tbody>
                <?php foreach ($broadcasts as $b): ?>
                    <tr>
                        <td><a href="<?= url('/admin/broadcasts/' . $b['id']) ?>"><?= e($b['subject']) ?></a></td>
                        <td><?= e($b['list_name'] ?? '—') ?></td>
                        <td>
                        ...
                        <td class="actions">
                            <?php if ($b['status'] === 'draft'): ?>
                                <a href="<?= url('/admin/broadcasts/' . $b['id'] . '/edit') ?>" class="btn btn-outline btn-tiny">Edit</a>
                            <?php else: ?>
                                <a href="<?= url('/admin/broadcasts/' . $b['id']) ?>" class="btn btn-outline btn-tiny">View</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>

...
<div class="admin-page">
    <div class="admin-page-header">
        <h1>Upload File</h1>
        <a href="/drivespace" class="btn btn-secondary">← Back to Files</a>
    </div>

    <form method="post" action="/drivespace/upload" enctype="multipart/form-data" class="form-card">
        <?= csrf_field() ?>
        ...
        <div class="form-actions">
            ...
            <a href="/drivespace" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>

...
(function () {
    ...
    // GöÇGöÇ Section G GÇö Block palette + delete GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ

    // Default CSS applied to new leaf blocks GÇö portrait ISO proportions (Gëê A4 at screen scale),
    ...
    var BLOCK_DEFS = {
        ...
        'event-list': { tag: 'div', inner: '<p class="editor-dynamic-placeholder">Event list GÇö visible on live page.</p>', dynamic: true, defaultConfig: { count: 5, filter: 'upcoming' }, initCss: PORTRAIT_INIT },
        'data-list': { tag: 'div', inner: '<p class="editor-dynamic-placeholder">Data List GÇö visible on live page.</p>', dynamic: true, defaultConfig: { set_slug: '', view: 'continuous', card_html: '' }, initCss: PORTRAIT_INIT },
        'module-widget': { tag: 'div', inner: '<p class="editor-dynamic-placeholder">Module Widget GÇö select widget in Content settings.</p>', dynamic: true, defaultConfig: { widget_key: '' }, initCss: PORTRAIT_INIT },
        ...
        'php-include': { tag: 'div', inner: '<p class="editor-dynamic-placeholder">PHP Include GÇö visible on live page.</p>', dynamic: true, defaultConfig: { template: '' }, initCss: PORTRAIT_INIT },
        'zone': {
    ...
    // GöÇGöÇ Block tree GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // GöÇGöÇ Accordion behaviour GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // GöÇGöÇ Section H GÇö Media panel GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // GöÇGöÇ Section I GÇö Serialise + recordAction GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // GöÇGöÇ Document panel (file-mode) GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // GöÇGöÇ End Document panel GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ

    function parseCssProps(style) {
        if (!style) { return null; }
        // Always return an object (possibly empty {}) GÇö an empty object signals
    ...
    // GöÇGöÇ Section J GÇö Undo / Redo GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // GöÇGöÇ Section K GÇö Publish / Discard GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    function bindToolbar() {
            ...
            publishBtn.addEventListener('click', function () {
                ...
                fetch(API_BASE + '/' + PAGE_ID + '/publish', {
                    ...
                    .then(function (data) {
                        if (data.success) {
                            if (data.reimported) {
                                alert('Published. Reloading editor GÇö undo history has been reset.');
                                location.reload();
                            } else {
        ...
        // GöÇGöÇ Code view toggle GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
        var codeBtn = document.getElementById('editor-code-toggle-btn');
        if (codeBtn) { codeBtn.addEventListener('click', toggleCodeView); }
    }

    // GöÇGöÇ Section N GÇö Code View GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // Block type GåÆ HTML tag mapping (mirrors PHP BlockRegistry)
    var BLOCK_TAGS = {
    ...
    /**
     * Very basic HTML formatter GÇö adds newlines before block-level tags.
     */
    ...
    (function () {
        ...
        editSrcBtn.addEventListener('click', function () {
            ...
            editSrcBtn.textContent = 'LoadingGÇª';
    ...
    // GöÇGöÇ Section M GÇö Canvas resize GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // GöÇGöÇ Section L GÇö Keyboard shortcuts GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ
    ...
    // GöÇGöÇ Section M GÇö Public API GöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇGöÇ

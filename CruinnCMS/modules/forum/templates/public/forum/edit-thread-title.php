...
<section class="container forum-page">
    ...
    <form method="post" action="<?= e($forumActionBasePath . '/thread/' . (int) $thread['id'] . '/edit-title') ?>" class="forum-edit-form">
        <?= csrf_field() ?>
        ...
        <div class="form-actions">
            ...
            <a href="<?= e(rtrim($forumBasePath, '/') . '/thread/' . (int) $thread['id']) ?>" class="btn btn-outline">Cancel</a>
        </div>
    </form>
</section>

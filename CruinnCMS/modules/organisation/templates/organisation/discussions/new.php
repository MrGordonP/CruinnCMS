<div class="organisation-discussion-new">
    ...
    <form method="post" action="/organisation/discussions" class="organisation-form">
        <?= csrf_field() ?>
        ...
        <div class="form-actions">
            ...
            <a href="/organisation/discussions" class="btn btn-secondary">Cancel</a>
        </div>
    </form>
</div>

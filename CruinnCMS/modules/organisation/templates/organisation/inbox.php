<div class="organisation-inbox">
    <div class="page-header">
        <h1>Organisation Inbox</h1>
    ...
    <div class="inbox-notice">
        ...
        <?php if (!empty($roundcubeUrl)): ?>
            <p>
                You can access the organisation email directly through Roundcube:
            </p>
        ...
        <div class="notice-details">
            ...
            <ul>
                ...
                <li>Username (default: organisation@example.com)</li>

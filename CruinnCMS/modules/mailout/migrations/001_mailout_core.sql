-- ============================================================
-- Mailout Module — Core Schema
-- ============================================================
-- Creates: mailing_lists, mailing_list_subscriptions,
--          email_broadcasts, email_queue, email_unsubscribes
-- ============================================================

-- Mailing lists that users can subscribe to
...
-- User subscriptions to mailing lists
...
-- Email queue (per-recipient delivery)
...
-- Global email suppression list (bounces, unsubscribes)

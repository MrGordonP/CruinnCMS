...
<div class="mailbox-compose">
    <h1 class="page-title"><?= e($page_title ?? 'Compose') ?></h1>

    <?php if ($errors): ?>
        <div class="form-errors">
            <?php foreach ($errors as $e): ?>
                <p class="form-error"><?= e($e) ?></p>
            <?php endforeach; ?>
        </div>
    <?php endif; ?>
...
<?= e($prefill['quote']) ?><?php endif; ?>
        ...
        <div class="form-actions">
            ...
            <span class="compose-from">From: <strong><?= e($mailbox['email'] ?? $mailbox['position']) ?></strong></span>
        </div>
    </form>
</div>

...
<div class="ml-workspace">
    ...
    <div class="ml-panel ml-panel-left">
        ...
        <div class="ml-panel-body">
            <form method="GET" action="<?= url('/admin/social/mailing-lists/' . (int)$list['id'] . '/members') ?>" id="source-filter-form">
                ...
                <a href="<?= url('/admin/social/mailing-lists/' . (int)$list['id'] . '/members') ?>" class="btn btn-outline btn-small" style="width: 100%; margin-top: var(--space-xs);">Clear All</a>
            </form>
        </div>
    </div>
        ...
        <div class="ml-panel-body" style="padding: 0;">
            <?php if ($source === 'manual'): ?>
                ...
                <div style="padding: var(--space-md);">
                    <form method="POST" action="<?= url('/admin/social/mailing-lists/' . (int)$list['id'] . '/members/add') ?>" id="manual-add-form">
                        <?= csrf_field() ?>
